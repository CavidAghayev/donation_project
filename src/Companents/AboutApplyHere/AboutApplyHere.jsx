...
function AboutApplyHere() {
  ...
  return (
     <section>
        ...
        <div className="about-apply-here-text">
            <p>Həyat Fondu icmasına qoşulmağa marağınızı yüksək qiymətləndiririk! Biz hazırda qeyri-kommersiya <br /> təşkilatı liderlərindən ibarət inanılmaz icmamızla işləyirik ki, qeyri-kommersiya təşkilatının qarşılanma <br /> təcrübəsini daha əhatəli və fandreyzinq bacarıqlarını təkmilləşdirməyə ümid edən hər kəs üçün əlçatan <br /> olsun. Əgər siz Həyat Fondunun daha ədalətli platformaya çevrilmə yolu haqqında daha çox öyrənmək <br /> istəyirsinizsə, burada “İcma tərəfindən idarə olunan dəyişiklikləri sürətləndirmək haqqında <br /> öyrəndiklərimiz” məqaləmiz var.</p>
      <p>Yeni proqrama dörd əsas təcrübə ətrafında cəmlənmiş rəhbər öyrənmə təcrübəsi daxil olacaq:  hekayənizi <br /> izah etmək, şəbəkənizi genişləndirmək, strategiyanızı planlaşdırmaq və münasibətlərinizi inkişaf etdirmək.</p>
